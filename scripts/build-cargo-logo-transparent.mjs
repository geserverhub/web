/**
 * Build transparent cargo-logo.png from public/cargo/cargo-logo.jpg
 * Run: node scripts/build-cargo-logo-transparent.mjs
 */
...
const src = path.join(root, 'public/cargo/cargo-logo.jpg');
const out = path.join(root, 'public/cargo/cargo-logo.png');
