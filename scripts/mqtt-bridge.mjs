...
function payloadToBody(raw, deviceId) {
  ...
  return {
    ...
    metrics_current_L1: num(raw, 'metrics_current_L1', 'after_current_L1'),
    metrics_current_L2: num(raw, 'metrics_current_L2', 'after_current_L2'),
    metrics_current_L3: num(raw, 'metrics_current_L3', 'after_current_L3'),
