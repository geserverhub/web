...
CREATE TABLE `CargoTransaction` (
  ...
  KEY `CargoTransaction_createdAt_idx` (`createdAt`),
...
('cargob1e1e0b3415111f1bf0a00155d839b3a','คาโก้ ไทย-เกาหลี / เกาหลี-ไทย',NULL,'cargo','บริการส่งสินค้าทางเครื่องบิน ไทย ↔ เกาหลี ปลอดภัย รวดเร็ว พร้อมติดตามสถานะออนไลน์','ONLINE','goeunserverhub@gmail.com','+66 095-241-1833',NULL,'/cargo/track','/uploads/logos/cargo.jpg',NULL,'2026-04-26 18:24:15.000','2026-04-26 18:24:15.000'),
('cmo6viudt0001qhga9f5j4jzc','M-Factory',NULL,'m-factory',NULL,'ONLINE','m.factoryandresort@gmail.com','+66 095-241-1833',NULL,'https://m-factoryandresort.com','/m-factory/LINE_ALBUM_12369_260417_1.jpg',NULL,'2026-04-24 23:13:22.775','2026-04-20 07:28:50.513'),
('cmo6viueb0002qhgad1v22u6k','M-Group',NULL,'m-group',NULL,'ONLINE','sale@m-group.in.th','089-4871144',NULL,NULL,'/m-group-building.jpg',NULL,'2026-04-20 07:28:50.531','2026-04-20 07:28:50.531'),
...
('cmo9bve0m0000qhtikd261ug2','Green Retail Group',NULL,'green-retail-group','ระบบมอนิเตอริ่ง ผู้ใช้ Demo','ONLINE','it@green-retail.example.com','02-555-1199',NULL,'/customer-dashboard-login','/uploads/logos/Guser-demo.png',NULL,'2026-04-22 00:42:02.038','2026-04-22 01:21:00.734'),
('gre28e9bf620415411f1bf0a00155d839b3a','Green Retail Group',NULL,'green-retail-energy','ระบบมอนิเตอริ่งพลังงานไฟฟ้า','ONLINE','it@green-retail.example.com','02-555-1199',NULL,'/energy-dashboard-login','/uploads/logos/G-monitoring.png',NULL,'2026-04-26 18:44:45.000','2026-04-26 18:44:45.000');
...
('cmofn7rhi0001jh3ie6eqatsf','cargob1e1e0b3415111f1bf0a00155d839b3a','Lee nilawan','010-6370-6861','leenilawan@gmail.com',NULL,NULL,NULL,'2026-04-26 10:46:12.198','2026-04-26 10:46:12.198');
...
CREATE TABLE `MGroupOrder` (
  ...
  `currency` varchar(191) NOT NULL DEFAULT 'THB',
  `status` enum('PENDING_PAYMENT','CONFIRMING','CONFIRMED','PROCESSING','SHIPPED','DELIVERED','CANCELLED') NOT NULL DEFAULT 'PENDING_PAYMENT',
  ...
  KEY `MGroupOrder_customerPhone_idx` (`customerPhone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ResortBooking` (
  ...
  `stayType` enum('HOURLY','OVERNIGHT') NOT NULL DEFAULT 'OVERNIGHT',
...
('001','admin','admin','admin',NULL,NULL,'$2b$12$dCIidoS/xEfM4W66XDR/ye0W0Gs634w3JriaTseY8fMTMeqEMYBLW','SUPER_ADMIN','2026-04-24 13:51:43.127','2026-04-25 16:28:42.762',NULL),
('002','pavinee  boknoi','ge-server','goeunserverhub@gmail.com','2026-04-26 13:20:20.000',NULL,'2350400018644','SUPER_ADMIN','2026-04-26 13:22:07.848','2026-04-26 13:20:20.000',NULL),
...
-- Dump completed on 2026-04-26 23:54:12
