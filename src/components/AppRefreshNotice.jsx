...
export default function AppRefreshNotice() {
  ...
  return (
    <div style={{ position: 'sticky', top: 0, zIndex: 4000, background: 'linear-gradient(90deg, #c2410c 0%, #ea580c 100%)', color: '#fff', boxShadow: '0 6px 24px rgba(0,0,0,.18)' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: '12px 18px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
        ...
        <button
          ...
          style={{ border: '1px solid rgba(255,255,255,0.3)', borderRadius: 999, background: '#fff', color: '#c2410c', fontWeight: 800, padding: '8px 14px', cursor: 'pointer' }}
        >
          รีเฟรช / Refresh
        </button>
      </div>
