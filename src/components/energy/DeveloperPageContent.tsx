...
const endpoints = [
  { method: 'GET', path: '/api/ge-energy/devices', desc: 'Device list' },
  ...
  { method: 'GET', path: '/api/ge-energy/notifications?site={site}', desc: 'Notifications' },
  { method: 'GET', path: '/api/ge-energy/device-notifications?site={site}', desc: 'Device alarms' },
  { method: 'GET', path: '/api/ge-energy/dashboard-stats?site={site}', desc: 'Dashboard stats' },
  { method: 'GET', path: '/api/ge-energy/meter-seting', desc: 'Meter configuration' },
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <code className="mt-2 inline-block text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">
                MySQL goeunserverhub → /api/ge-energy/*
              </code>
            </div>
          </div>
        </section>
