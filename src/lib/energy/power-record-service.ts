...
export function mqttPayloadToPowerRecord(
  ...
  return {
    ...
    metrics_current_L1: numFromPayload(raw, 'metrics_current_L1', 'after_current_L1'),
    metrics_current_L2: numFromPayload(raw, 'metrics_current_L2', 'after_current_L2'),
    metrics_current_L3: numFromPayload(raw, 'metrics_current_L3', 'after_current_L3'),
