...
const th: EqStrings = {
  ...
  tagline: 'การวิเคราะห์คุณภาพพลังงาน (เปรียบเทียบ CH1/CH2)',
  location: 'โลเคชั่น',
  ...
  beforeCurrent: 'กระแส CH1 (ไม่ผ่านอุปกรณ์)',
  afterCurrent: 'กระแส CH2 (ผ่านอุปกรณ์)',
  thd: 'THD',
...
const ko: EqStrings = {
  ...
  avg: '3상 평균',
  totalPhase: '3상 합계',
  beforeCurrent: 'CH1 전류 (장치 미적용)',
  afterCurrent: 'CH2 전류 (장치 적용)',
  thd: 'THD',
  powerFactor: '역률',
  frequency: '주파수',
  errorLoad: '데이터 로드 실패',
...
const en: EqStrings = {
  ...
  tagline: 'Energy Quality Analysis (CH1/CH2 Comparison)',
  location: 'Location',
  ...
  beforeCurrent: 'CH1 current (without device)',
  afterCurrent: 'CH2 current (with device)',
  thd: 'THD',
  powerFactor: 'Power Factor',
  frequency: 'Frequency',
...
const cn: EqStrings = {
  ...
  avg: '三相平均',
  totalPhase: '三相合计',
  beforeCurrent: 'CH1 电流（未接装置）',
  afterCurrent: 'CH2 电流（接入装置）',
  thd: 'THD',
  powerFactor: '功率因数',
  frequency: '频率',
  errorLoad: '加载数据失败',
...
const vn: EqStrings = {
  ...
  tagline: 'Phân tích chất lượng năng lượng (so sánh CH1/CH2)',
  location: 'Vị trí',
  ...
  beforeCurrent: 'Dòng CH1 (chưa qua thiết bị)',
  afterCurrent: 'Dòng CH2 (qua thiết bị)',
  thd: 'THD',
...
const ms: EqStrings = {
  ...
  tagline: 'Analisis Kualiti Tenaga (Perbandingan CH1/CH2)',
  location: 'Lokasi',
  ...
  beforeCurrent: 'Arus CH1 (tanpa peranti)',
  afterCurrent: 'Arus CH2 (dengan peranti)',
  thd: 'THD',
