...
const en: MonitorPageStrings = {
  ...
  meterBefore: 'Meter (CH1)',
  meterAfter: 'Meter (CH2)',
  beforeGeInstall: 'CH1 (Without Device)',
  afterGeInstall: 'CH2 (With Device)',
  energyAndSavings: 'Energy & Savings',
  ch1EnergyBefore: 'CH1 Energy (Without Device)',
  ch2EnergyAfter: 'CH2 Energy (With Device)',
...
const th: MonitorPageStrings = {
  ...
  ch1Input: 'CH1 · INPUT',
  ch2Output: 'CH2 · OUTPUT',
  meterBefore: 'มิเตอร์ (CH1)',
  meterAfter: 'มิเตอร์ (CH2)',
  beforeGeInstall: 'CH1 (ไม่ผ่านอุปกรณ์ GE)',
  afterGeInstall: 'CH2 (ผ่านอุปกรณ์ GE)',
  energyAndSavings: 'พลังงานและการประหยัด',
  ch1EnergyBefore: 'พลังงาน CH1 (ไม่ผ่านอุปกรณ์)',
  ch2EnergyAfter: 'พลังงาน CH2 (ผ่านอุปกรณ์)',
...
const ko: MonitorPageStrings = {
  ...
  meterBefore: '미터 (CH1)',
  meterAfter: '미터 (CH2)',
  beforeGeInstall: 'CH1 (GE 장치 미적용)',
  afterGeInstall: 'CH2 (GE 장치 적용)',
  energyAndSavings: '에너지 및 절감',
  ch1EnergyBefore: 'CH1 에너지 (장치 미적용)',
  ch2EnergyAfter: 'CH2 에너지 (장치 적용)',
  energySaved: '절약 에너지',
  co2Saved: 'CO₂ 절감',
  thdReduction: 'THD 감소',
  trendChart: '추세 차트',
...
const cn: MonitorPageStrings = {
  ...
  meterBefore: '电表（CH1）',
  meterAfter: '电表（CH2）',
  beforeGeInstall: 'CH1（未接GE装置）',
  afterGeInstall: 'CH2（已接GE装置）',
  energyAndSavings: '能源与节约',
  ch1EnergyBefore: 'CH1 电能（未接装置）',
  ch2EnergyAfter: 'CH2 电能（已接装置）',
  energySaved: '节约电能',
  co2Saved: 'CO₂ 减排',
  thdReduction: 'THD 降低',
  trendChart: '趋势图',
...
const vn: MonitorPageStrings = {
  ...
  thdBefore: 'THD (CH1)',
  thdAfter: 'THD (CH2)',
  meterBefore: 'Dong ho (CH1)',
  meterAfter: 'Dong ho (CH2)',
  beforeGeInstall: 'CH1 (chua qua thiet bi GE)',
  afterGeInstall: 'CH2 (qua thiet bi GE)',
  energyAndSavings: 'Nang luong & tiet kiem',
  ch1EnergyBefore: 'Nang luong CH1 (chua qua thiet bi)',
  ch2EnergyAfter: 'Nang luong CH2 (qua thiet bi)',
...
const ms: MonitorPageStrings = {
  ...
  meterBefore: 'Meter (CH1)',
  meterAfter: 'Meter (CH2)',
  beforeGeInstall: 'CH1 (Tanpa Peranti GE)',
  afterGeInstall: 'CH2 (Dengan Peranti GE)',
  energyAndSavings: 'Tenaga & Penjimatan',
  ch1EnergyBefore: 'Tenaga CH1 (Tanpa Peranti)',
  ch2EnergyAfter: 'Tenaga CH2 (Dengan Peranti)',
