const UI = {
  th: {
    ...
    pageSubtitle:
      "เลือกรายการ → โอนเงินและแนบสลิป → ดาวน์โหลดได้เมื่อสถานะเป็น「ชำระเงินแล้ว」",
    ...
    lookupSection: "ตรวจคำสั่งซื้อ และรหัสผ่าน",
    orderCodeLabel: "รหัสคำสั่งซื้อ",
    checkBtn: "ตรวจสอบ",
    loginLinkLabel: "เข้าสู่ระบบแอป",
    passwordLabel: "รหัสผ่าน",
    loginEmailHint: "ใช้อีเมลที่สั่งซื้อเป็นชื่อผู้ใช้",
    copyPassword: "คัดลอก",
    copiedPassword: "คัดลอกแล้ว",
    lookupWaitingPayment: "คำสั่งซื้อยังไม่ชำระเงิน — โอนเงินและแนบสลิปในส่วนสั่งซื้อด้านบน",
    credentialsReady: "พบคำสั่งซื้อ — ใช้ลิงก์และรหัสผ่านด้านล่างเข้าแอป",
    downloadBtn: "ดาวน์โหลด",
    downloadFreeBtn: "ดาวน์โหลดฟรี",
    orderBtn: "สั่งซื้อ",
    bankTitle: "โอนเงินตามรายละเอียดด้านล่าง",
    bankCompanyLabel: "บริษัท",
    bankNameLabel: "ธนาคาร",
    accountNameLabel: "ชื่อบัญชี",
    accountNoLabel: "เลขบัญชี",
    transferAmountLabel: "ยอดโอน",
    free: "ฟรี",
    won: "วอน",
    orderCodePrefix: "รหัส",
    statusLabel: "สถานะ",
    downloadable: "ดาวน์โหลดได้",
    payHint: "โอนเงินตามเลขบัญชีด้านล่าง แล้วแนบสลิป (รอแอดมินยืนยัน)",
    orderCreatedBank: "สร้างคำสั่งซื้อแล้ว — โอนเงินและแนบสลิปด้านล่าง",
    ...
    paidSuccess: "ชำระเงินสำเร็จ — ตรวจสอบรหัสผ่านด้านล่างเพื่อเข้าแอป",
  ...
  en: {
    ...
    pageSubtitle:
      "Choose an item → bank transfer + upload slip → download when status is「Paid」",
    ...
    lookupSection: "Check order & password",
    orderCodeLabel: "Order code",
    checkBtn: "Check",
    loginLinkLabel: "Open app login",
    passwordLabel: "Password",
    loginEmailHint: "Use your order email as the username",
    copyPassword: "Copy",
    copiedPassword: "Copied",
    lookupWaitingPayment: "Payment not confirmed yet — complete bank transfer in the order section above",
    credentialsReady: "Order found — use the login link and password below",
    downloadBtn: "Download",
    downloadFreeBtn: "Free download",
    orderBtn: "Order",
    bankTitle: "Transfer to the account below",
    ...
    payHint: "Transfer to the account below, then upload your slip (admin approval required)",
    orderCreatedBank: "Order created — transfer payment and upload your slip below",
    ...
    paidSuccess: "Payment successful — check your password below to access the app",
  ...
  ko: {
    ...
    pageSubtitle:
      "항목 선택 → 계좌 이체 및 영수증 업로드 → 상태가「결제 완료」일 때 다운로드",
    ...
    lookupSection: "주문 확인 및 비밀번호",
    orderCodeLabel: "주문 코드",
    checkBtn: "확인",
    loginLinkLabel: "앱 로그인",
    passwordLabel: "비밀번호",
    loginEmailHint: "주문 시 사용한 이메일을 아이디로 사용하세요",
    copyPassword: "복사",
    copiedPassword: "복사됨",
    lookupWaitingPayment: "아직 결제 확인 전입니다 — 위 주문 섹션에서 이체 및 영수증을 제출해 주세요",
    credentialsReady: "주문 확인됨 — 아래 링크와 비밀번호로 앱에 접속하세요",
    downloadBtn: "다운로드",
    downloadFreeBtn: "무료 다운로드",
    orderBtn: "주문",
    bankTitle: "아래 계좌로 이체해 주세요",
    bankCompanyLabel: "회사",
    bankNameLabel: "은행",
    ...
    payHint: "아래 계좌로 이체한 후 영수증을 업로드해 주세요 (관리자 승인 필요)",
    orderCreatedBank: "주문이 생성되었습니다 — 아래 계좌로 이체 후 영수증을 업로드해 주세요",
    ...
    paidSuccess: "결제 완료 — 아래 비밀번호로 앱에 접속하세요",
