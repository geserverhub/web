export const translations = {
  th: {
    ...
    navPhoneRemote: "รีโมทหน้าจอ",
    navSoftwareDownloads: "ดาวน์โหลดซอฟต์แวร์",
    navFileConverter: "แปลงไฟล์มือถือ",
    navTools: "เครื่องมือ",
    ...
    searchPlaceholder: "พิมพ์ชื่อบริษัท",
    filterAll: "ทั้งหมด",
    ...
    clientDescriptions: {
      ...
      "software-downloads": {
        ...
        description: "ดาวน์โหลดแอปและไฟล์ใช้งาน — ชำระเงินแล้วดาวน์โหลดได้ทันที",
      },
      "spfoods": {
    ...
    orderCreatedAndSlipUploaded: "สร้างคำสั่งซื้อสำเร็จและแนบสลิปเรียบร้อยแล้ว",
    customerConnectedMarketplace: "Customer Connected Marketplace",
    checkOrderStatus: "เช็กสถานะออเดอร์",
    ...
    openPromptpayInstructions: "เปิดลิงก์ PromptPay QR / ขั้นตอนชำระเงิน",
  },
  en: {
    brandKicker: "Agency-Inspired Client Hub",
    brandSubtitle: "Service Showcase and Multi-Client Access",
    ...
    navContact: "Contact",
    navLogin: "Sign In",
    navPhoneRemote: "Phone Remote",
    navSoftwareDownloads: "Software downloads",
    navFileConverter: "Mobile File Converter",
    navTools: "Tools",
    heroKicker: "GOEUN DIGITAL INFRASTRUCTURE",
    ...
    orderCreatedAndSlipUploaded: "Order created and slip uploaded successfully",
    customerConnectedMarketplace: "Customer Connected Marketplace",
    ...
    uploadSlipFile: "Upload payment slip",
  ...
  zh: {
    ...
    navLogin: "登录",
    navPhoneRemote: "远程屏幕",
    navSoftwareDownloads: "软件下载",
    navFileConverter: "移动文件转换",
    navTools: "工具",
    heroKicker: "GOEUN DIGITAL INFRASTRUCTURE",
    ...
    paymentStatus: "付款状态",
    grandTotal: "总计",
    productsFromPartner: "合作伙伴商品",
    loadingProducts: "加载商品中...",
    noProductsInPartner: "暂无商品",
    model: "型号",
    brand: "品牌",
    unit: "件",
    marketplaceCartTitle: "购买 & 实时付款",
    cartEmpty: "购物车为空",
    customerName: "客户姓名",
    ...
    openingStripe: "跳转至 Stripe...",
    payWithStripeCard: "银行卡付款 (Stripe)",
    creatingPromptpay: "创建 PromptPay...",
    payWithPromptpay: "PromptPay 付款 (Stripe)",
    openPromptpayInstructions: "打开 PromptPay 二维码 / 付款说明",
  },
  ko: {
    ...
    navContact: "문의",
    navLogin: "로그인",
    navPhoneRemote: "원격 화면",
    navSoftwareDownloads: "소프트웨어 다운로드",
    navFileConverter: "모바일 파일 변환",
    navTools: "도구",
    heroKicker: "GOEUN DIGITAL INFRASTRUCTURE",
    ...
    orderStatusCheckFailed: "주문 상태 조회 실패",
    loadProductsFailed: "상품 로드 실패",
    uploadSlipFailed: "입금 확인증 업로드 실패",
    pleaseSelectAtLeastOneProduct: "상품을 1개 이상 선택해 주세요",
    orderCreateFailed: "주문 생성 실패",
    orderCreatedSuccess: "주문이 완료되었습니다",
    orderCreatedAndSlipUploaded: "주문 완료 및 입금 확인증 업로드 완료",
    customerConnectedMarketplace: "고객 연결 마켓플레이스",
    checkOrderStatus: "주문 상태 조회",
    enterOrderNumberExample: "주문번호 입력 예: MKT20260517-0001",
    orderNumber: "주문번호",
    checkingStatus: "조회 중...",
    checkStatus: "상태 조회",
    status: "상태",
    ...
    uploadSlipFile: "입금 확인증 업로드",
    selectedFile: "선택된 파일",
    confirmOrder: "주문 확인",
    creatingOrder: "주문 생성 중...",
    uploadingSlip: "확인증 업로드 중...",
    ...
    openPromptpayInstructions: "PromptPay QR / 결제 안내 열기",
  },
};
