-- GE Energy monitoring tables — database: geserverhub only
-- Run: mysql -u root -p geserverhub < prisma/migrate-energy-geserverhub.sql
...
-- Legacy: rename ksaveID → geID if upgrading from old schema
SET @col_exists = (
